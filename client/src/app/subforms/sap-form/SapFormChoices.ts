...
export let Section2Choices = [
	...
	{dept:'Accounts Receivable/Sales & Distribution',
		items:[
			'Police',
			'Fire',
			'All Other',
			'Sales Order Specialist',
			'Departmental Billing Specialis',
	...
	{dept:'Police Department Off Duty',
		items:[
	...
	{dept:'Business Information Warehouse (BW)',
		items:[
	...
	{dept:'Aviation Only – Airline Statistics',
		items:[
...
export let Section3Choices = [
	{
		...
		items:[
			...
			'SAePS Commodity Approver',
			'SAePS Fiscal Approver',
			'SAePS Buyer',
			'SAePS/ECC Shopper/Requisitioners',
			'SAePS Legal Approver',
			'',
			''
		]
	},
...
export let Section4Choices = [
	{
		dept:'Human Resources / HR Designee Approval',
		items:[
	...
	{
		dept:'Department Roles Purchasing Designee Approval',
		items:[
	...
	{
		dept:'Budget Department (Funds Management)',
		items:[
